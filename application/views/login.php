...
<div class="container">
        <form id="my-form" class="form_container" method="post" action="traitement/log_in" data-parsley-validate="">
            <div class="logo_container">
                <img src="<?=base_url()?>assets/img/logo.png" style="width: 100px;height: 90px;" alt="">
            </div>
            <div class="title_container">
              <p class="title">Login to your Society Account</p>
            ...
            <div class="input_container">
              ...
              <input placeholder="name@mail.com" title="Inpit title" name="email" type="email" value="fraise@genius.com" class="input_field" id="email_field" data-parsley-validate="change" required>
            </div>
            <div class="input_container">
              ...
              <input placeholder="Password" title="Inpit title" name="password" value="heart265!" type="password" class="input_field" id="password_field" required>
            </div>
            <button title="Sign In" type="submit" class="sign-in_btn">
              <span>Sign In</span>
            </button>
            <p>Don't have an account ? <a href="<?=base_url()?>sign/inscription">Sign up </a></p>
          </form>

          <div class="svg-container">
            <img src="<?=base_url()?>assets/img/pwd.svg" alt="SVG Image">
          </div>
    </div>

    <script src="<?php echo site_url("assets/js/spinner.js") ?>">
</script>
